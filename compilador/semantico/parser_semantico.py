...
class ParserSemantico:
    ...
    def __init__(self, lexer):
        ...
        self.funcao_atual = None  # Função sendo analisada atualmente
    ...
    def dc_v(self):
        ...
        # SEMÂNTICA: Declara a variável na tabela de símbolos
        ...
        # SEMÂNTICA: Marca como inicializada após a expressão
        ...
        print(f"[Semântico] Variável '{variavel_nome}' inicializada")
    ...
    def dc_f(self):
        ...
        # SEMÂNTICA: Declara a função na tabela de símbolos
        ...
        # SEMÂNTICA: Entra no escopo da função
        self.tabela_simbolos.entrar_escopo()
        
        # Declara os parâmetros como variáveis no escopo da função
        for param in parametros:
            simbolo = self.tabela_simbolos.declarar_variavel(param, funcao.line, funcao.column)
            simbolo.inicializado = True  # Parâmetros já vêm inicializados
        
        self.corpo_f()
        
        # SEMÂNTICA: Sai do escopo da função
    ...
    def comando(self):
        ...
        if self.token_atual.type == "PRINT":
            ...
            # SEMÂNTICA: Verifica se a variável existe e foi inicializada
            ...
            # SEMÂNTICA: Entra em novo escopo para o bloco if
            self.tabela_simbolos.entrar_escopo()
            self.bloco()
            self.tabela_simbolos.sair_escopo()
            ...
            # SEMÂNTICA: Entra em novo escopo para o bloco while
            self.tabela_simbolos.entrar_escopo()
            self.bloco()
            self.tabela_simbolos.sair_escopo()
        else:
    ...
    def pfalsa(self):
        ...
        if self.token_atual.type == "ELSE":
            ...
            # SEMÂNTICA: Entra em novo escopo para o bloco else
            self.tabela_simbolos.entrar_escopo()
            self.bloco()
            self.tabela_simbolos.sair_escopo()
    ...
    def restoIdent(self, ident_token):
        ...
        if self.token_atual.type == "ATRIB":
            ...
            # SEMÂNTICA: Verifica se a variável existe
            ...
            # SEMÂNTICA: Marca como inicializada
            self.tabela_simbolos.marcar_inicializado(
                ident_token.value,
                ident_token.line,
                ident_token.column
            ...
            # Chamada de função
            # SEMÂNTICA: Verifica se a função existe
            simbolo = self.tabela_simbolos.buscar(ident_token.value)
            if simbolo is None:
            ...
            # SEMÂNTICA: Verifica número de argumentos
    ...
    def fator(self):
        ...
        if self.token_atual.type == "IDENT":
            ...
            # SEMÂNTICA: Verifica se existe e foi inicializada
            self.tabela_simbolos.verificar_inicializado(
                nome.value,
                nome.line,
                nome.column
